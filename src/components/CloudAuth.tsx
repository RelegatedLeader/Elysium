...
const CloudAuth: React.FC<CloudAuthProps> = ({ onAuthenticated, onCancel }) => {
  const { signIn, signUp, signInWithGoogle, loading, error } =
    useCloudStorage();
          ...
          <div className="mb-6">
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>
                      To use cloud features, you need to set up a Firebase
                      project.
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-3 text-sm text-gray-600">
              ...
              <div className="flex items-start">
                ...
                <p>
                  Enable Authentication, Firestore, and Storage in your project
                </p>
              </div>
              <div className="flex items-start">
                <span className="flex-shrink-0 w-5 h-5 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs font-medium mr-3 mt-0.5">
        ...
        <div className="p-6 pb-4 flex-shrink-0">
          ...
          <div className="mb-4">
            <p className="text-gray-300 text-sm">
              Access your notes from anywhere with Firebase Cloud Storage. Free
              tier includes 5GB storage and unlimited notes.
            </p>
          </div>
        </div>
                ...
                <div>
                  ...
                  {error.includes("operation-not-allowed") && (
                    <p className="text-xs mt-2 text-yellow-300">
                      Google sign-in needs to be enabled in Firebase Console →
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gradient-to-r from-indigo-900 to-purple-700 text-gray-400">
                  Or continue with
                </span>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-xs text-blue-200 mt-1">
                  5GB storage • Unlimited notes • Cross-device sync • Public
                  sharing
                </p>
              </div>
            </div>
